...
```html
<img
  src="/images/icons/plaincode_logo_text.svg"
  alt="plaincode"
  width="347"
  height="74"
  fetchpriority="high"
...
<meta
  property="og:image"
  content="https://www.plaincode.com/images/icons/APP_ICON_OR_plaincode_logo.jpg"
/>
...
**CRITICAL: Keep AGENTS.md synchronized with project changes.**
